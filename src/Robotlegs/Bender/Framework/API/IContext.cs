...
namespace Robotlegs.Bender.Framework.API
{
	public interface IContext : IPinEvent, ILifecycleEvent
	{
		...
		/// <summary>
		/// A asynchronous handler to run before the context is initialized. This is before the configs have been processed
		/// </summary>
		/// <returns>This</returns>
		/// <param name="handler">Handler to fire, you must fire the callback given to the hander to continue initialization</param>
		...
		/// </summary>
		/// <returns>This</returns>
		/// <param name="handler">Handler to fire, you must fire the callback given to the hander to continue suspension</param>
		...
		/// </summary>
		/// <param name="handler">Handler to fire, you must fire the callback given to the hander to continue resumption</param>
		...
		/// </summary>
		/// <returns>The destroying.</returns>
		/// <param name="handler">Handler to fire, you must fire the callback given to the hander to continue destruction</param>
