...
namespace strange.extensions.injector.impl
{
	public class InjectionBinder : Binder, IInjectionBinder
	{
		...
		public virtual object GetOrCreateNewInstance(Type key)
		{
			IInjectionBinding binding = GetBinding (key, null) as IInjectionBinding;
			if (binding == null)
				return InstantiateUnmapped (key);
			return GetInjectorForBinding(binding).Instantiate (binding);
		}

		public IInjectionBinder CreateChild()
		{
			return this;
		}
